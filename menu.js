...
const menuItems = [
  {
    name: "Plasma Rolls",
    shortDescription: "Electric spice rolls with holographic glaze",
  ...
  {
    name: "Nova Curry",
    shortDescription: "Galactic blend with starlight rice",
  ...
  {
    name: "Cyber Tacos",
    shortDescription: "Tri-shell with neon aioli",
  ...
  {
    name: "Quantum Shake",
    shortDescription: "Vanilla shake with glow dust",
